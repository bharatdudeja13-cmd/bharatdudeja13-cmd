...
Then point your AI at [`dot-skill/skillerr`](https://github.com/dot-skill/skillerr) (or paste a short prompt asking it to install `skillerr` and create a `.skill` from your conversation).
